...
end_times = range(200, 203, 2) #osnap
...
if ma.isMaskedArray(data[time_begin:end_times[0],0,0]):
...
#-------------------------------------------------------------------------------------------------------------
#Store data
with netcdf.Dataset(directory_output + 'lambda_TEMP_transient_1500_endtimes_1700_1702_spacing_2_window_'+str(window)+'_OSNAP_all_gridpoints.nc', 'w') as f:
